...
public class TextMessage extends JPanel {
	...
	public TextMessage(String MSG) {
		...
		/*
		 * Time in the North, message in the center, user image in the east or in the
		 * west depending on message order, Likes, Read notification, and read time
		 * stamp in South.
		 */
		...
		int indents = MSG.length() / 35;
		String editedMsg = MSG.indent(indents);
		...
		ImageIcon likes = new ImageIcon();
		ImageIcon dislikes = new ImageIcon();
		ImageIcon beanRead = new ImageIcon();
